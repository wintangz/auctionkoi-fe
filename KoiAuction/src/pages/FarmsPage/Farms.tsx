      ...
      {loading ? (
        ...
        <div className='farm-page'>
          <section className='farm-description'>
            <h1>Farms</h1>
            <p>
              With a deep understanding of genetics, breeding techniques, and water quality management, reputable
              breeders strive to produce koi with the most desirable traits—whether it's vibrant colors, balanced
              markings, or graceful swimming behavior.
            </p>
            <img
            ...
            />
            <p>
              Breeders from renowned farms in Japan, such as Dainichi, Momotaro, and Sakai, are highly respected for
              their generations of expertise and their contribution to the koi hobby. The koi produced by these breeders
              are often showcased in auctions, where collectors and hobbyists alike bid for a chance to own these
              magnificent living jewels.
            </p>
          </section>
